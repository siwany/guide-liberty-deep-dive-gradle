...
When you’re finished trying out the application, run the following command to stop the container:
...
In the `build.gradle`, add the `<configuration>` element as the following:
